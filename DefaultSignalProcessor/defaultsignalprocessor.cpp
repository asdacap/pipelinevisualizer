...
QList<PipeProcessGraphicsProvider*> DefaultSignalProcessor::getProviders(PVisual *pv){
    ...
    thelist.append(new SimpleProcessGraphicsProviderTemplate<ConditionalOutputSignalPipe>("ConditionalOutputSignalPipe",pv,1,2,0,0,1,0));
    thelist.append(new SimpleProcessGraphicsProviderTemplate<ConditionalInputSignalPipe>("ConditionalInputSignalPipe",pv,2,1,0,0,1,0));
    ...
    thelist.append(new SimpleProcessGraphicsProviderTemplate<BlockGenerator>("VariableBlockGenerator",pv,1,1,2,0,0,0));
    ...
    thelist.append(new SimpleProcessGraphicsProviderTemplate<SelectiveValuePipe>("SelectiveValuePipe",pv,1,1,2,0,1,0));
    thelist.append(new BlockNormalizerProvider(pv));
    thelist.append(new SimpleProcessGraphicsProviderTemplate<SignalExpander>("SignalExpander",pv,1,1,2,0,1,0));
    thelist.append(new SimpleProcessGraphicsProviderTemplate<SelectiveSignalElimination>("SelectiveSignalElimination",pv,1,1,2,0,0,0));
